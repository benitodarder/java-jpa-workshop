...
public class ComponentDAOTest extends BaseDAOTest {
    ...
    private local.tin.tests.jpa.workshop.model.domain.product.Component domainObject;
    private local.tin.tests.jpa.workshop.model.data.product.Component dataObject;
    private UnitDAO mockedUnitDAO;
    private local.tin.tests.jpa.workshop.model.domain.product.Unit mockedDomainUnit;
    private local.tin.tests.jpa.workshop.model.data.product.Unit mockedDataUnit;
    ...
    public void setUp() throws DAOException {   
        ...
        domainObject = new local.tin.tests.jpa.workshop.model.domain.product.Component();
        dataObject = new local.tin.tests.jpa.workshop.model.data.product.Component();
        mockedUnitDAO = mock(UnitDAO.class);
        when(mockedDAOFactory.getDAO(local.tin.tests.jpa.workshop.model.data.product.Unit.class)).thenReturn(mockedUnitDAO);
        mockedDomainUnit = mock(local.tin.tests.jpa.workshop.model.domain.product.Unit.class);
        mockedDataUnit = mock(local.tin.tests.jpa.workshop.model.data.product.Unit.class);        
