...
public class ProductDAOTest extends BaseDAOTest {
    ...
    private local.tin.tests.jpa.workshop.model.domain.product.Product domainObject;
    private local.tin.tests.jpa.workshop.model.data.product.Product dataObject;
    ...
    public void setUp() throws DAOException {    
        ...
        domainObject = new local.tin.tests.jpa.workshop.model.domain.product.Product();
        dataObject = new local.tin.tests.jpa.workshop.model.data.product.Product();
    }
