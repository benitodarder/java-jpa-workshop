...
public class ComponentDAO extends AbstractEnableableDAO<local.tin.tests.jpa.workshop.model.domain.product.Component, Component> {
    ...
    @Override
    protected local.tin.tests.jpa.workshop.model.domain.product.Component getDomainObjectNewInstance() {
        return new local.tin.tests.jpa.workshop.model.domain.product.Component();
    }
    ...
    @Override
    protected local.tin.tests.jpa.workshop.model.domain.product.Component updateDomainObjectDepth0Fields(local.tin.tests.jpa.workshop.model.domain.product.Component domainObject, Component dataObject) throws DAOException {
        domainObject.setName(dataObject.getName());
        return domainObject;
    }

    @Override
    protected local.tin.tests.jpa.workshop.model.domain.product.Component updateDomainObjectDeeperFields(local.tin.tests.jpa.workshop.model.domain.product.Component domainObject, Component dataObject, int depth) throws DAOException {
    ...
    @Override
    protected Component updateDataObjectDepth0Fields(local.tin.tests.jpa.workshop.model.domain.product.Component domainObject, Component dataObject) throws DAOException {
        dataObject.setName(domainObject.getName());
        return dataObject;
    }

    @Override
    protected Component updateDataObjectDeeperFields(local.tin.tests.jpa.workshop.model.domain.product.Component domainObject, Component dataObject, int depth) throws DAOException {
        UnitDAO unitDAO = (UnitDAO) ProductDAOFactory.getInstance().getDAO(Unit.class);
