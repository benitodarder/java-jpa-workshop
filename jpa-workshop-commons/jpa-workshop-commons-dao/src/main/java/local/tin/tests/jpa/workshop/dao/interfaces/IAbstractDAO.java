package local.tin.tests.jpa.workshop.dao.interfaces;
 ...
 * @param <C0>
 */
public interface IAbstractDAO<C0 extends local.tin.tests.jpa.workshop.model.domain.interfaces.IIdentifiable> {
