...
public class UnitDAOTest extends BaseDAOTest {
    ...
    private UnitDAO dao;
    private local.tin.tests.jpa.workshop.model.domain.product.Unit domainObject;
    private local.tin.tests.jpa.workshop.model.data.product.Unit dataObject;
    ...
    public void setUp() throws DAOException {
        ...
        domainObject = new local.tin.tests.jpa.workshop.model.domain.product.Unit();
        dataObject = new local.tin.tests.jpa.workshop.model.data.product.Unit();
    }
