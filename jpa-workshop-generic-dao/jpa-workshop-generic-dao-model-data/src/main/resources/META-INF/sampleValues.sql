...
INSERT INTO COMPONENT (UNITID,NAME, enabled) VALUES ((SELECT id from unit WHERE abbreviation = 'ml'),'cream', false)
INSERT INTO COMPONENT (UNITID,NAME, enabled) VALUES ((SELECT id from unit WHERE abbreviation = 'ml'),'oil', false)
